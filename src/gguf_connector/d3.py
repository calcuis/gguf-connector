...
if safetensors_files:
    ...
    try:
        ...
        output_str= f"{os.path.splitext(input_file)[0]}_bf16.safetensors"
        output_file = Path(output_str)
        convert(input_file, output_file, 1024, False)
        print(f"Converted safetensors saved to {output_file}.")
