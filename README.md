...
[![Static Badge](https://img.shields.io/badge/version-3.7.0-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
...
ggc et
```
Select a gguf file in your current directory to edit/quantize; *support CUDA, ROCm, Metal, etc., see [gguf-editor](https://pypi.org/project/gguf-editor/) for details
#### gguf.cpp
Unified engine (optional: need gguf-cpp to work; `pip install gguf-cpp`):
```
ggc gp
```
