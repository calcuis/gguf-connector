...
[![Static Badge](https://img.shields.io/badge/version-2.3.7-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
...
ggc k8
```
Opt a model file in the current directory to interact with (see example [here](https://huggingface.co/calcuis/kontext-gguf))
### Menu
