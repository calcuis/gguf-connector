...
[![Static Badge](https://img.shields.io/badge/version-2.3.8-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
...
#### K-flux connector
Select flux model(s) with k connector:
```
ggc k
```
### Menu
