...
[![Static Badge](https://img.shields.io/badge/version-0.5.3-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
...
```
### Menu
Enter the main menu for selecting a connector or getting pre-trained model(s)
```
gguf m
```
#### Import as a module
