...
[![Static Badge](https://img.shields.io/badge/version-2.9.9-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
...
#### Sketch connector (sketch for picture)
Let's draw something with s8 connector:
```
ggc s8
```
