...
[![Static Badge](https://img.shields.io/badge/version-3.4.4-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
[![Static Badge](https://img.shields.io/badge/version-0.1.0-blue?logo=gitforwindows)](https://github.com/gguf-org/fat/releases)
[![Static Badge](https://img.shields.io/badge/version-1.0.0-gray?logo=linux)](https://github.com/gguf-org/gguf-desktop/releases)
...
```
#### pixel 🎨🔌
Pixel connector for backend api:
```
ggc pz
```
Pixel connector (optional: need gguf-pixel to work; pip install gguf-pixel):
```
ggc px
```
Train your own or get the sample model [here](https://huggingface.co/gguf-org/pixel)
#### gan trainer 🎨🤖
...
```
#### openclaw 🦞️
OpenClaw (optional: need openclaw to work; npm install -g openclaw):
```
ggc oc
```
#### gold 🔸
Gold agent (optional: need gold to work; see [here](https://github.com/mochiyaki/gold)):
```
ggc go
```
#### durian 𖤓𖦹
