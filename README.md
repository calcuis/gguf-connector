...
[![Static Badge](https://img.shields.io/badge/version-2.2.9-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
...
ggc h2
```
Multilinguage supported, i.e., Spanish, German, Korean, etc.
#### Bagel 2 (any to any)
